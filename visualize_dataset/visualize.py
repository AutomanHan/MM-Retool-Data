    ...
    def _load_data(self):
        with open(self.data_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                for msg in json.loads(item['message']):
...
# 初始化数据加载器
data_jsonl="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-basecv/hancong/code/pretrain/reasoning/data/MM-Eureka-Dataset/dataset_qhb/dataset_k12_filtered_for_qwen_instruct.jsonl"
